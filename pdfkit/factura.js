...
doc.fontSize(15).text((fecha),10, 102);// fecha de la factura
...
doc.rect(280,50,275,25).stroke() ;// numero factura
...
doc.moveUp().fillColor('black');//total factura
...
doc.rect(138,679,417,25).fill("#cacfd2").moveDown().stroke() ;//relleno caslla total factura
doc.moveUp().fillColor('#ec7063');//total factura
doc.fontSize(14).text(('Total factura: '),140, 685);// total factura
doc.fontSize(14).text(('Total factura: '),140, 685);// total factura
doc.fontSize(14).text((rfactura),480, 685);//total factura recivido
//imagen escala
